...
public class RaidConfig {
    ...
    public static void syncConfig(FMLPreInitializationEvent event) {
        ...
        try{
            ...
            normalWaves = config.get("general", "normalWaves", 3, "How many waves do raids last for on normal mode?").getInt();
            hardWaves = config.get("general", "hardWaves", 3, "How many waves do raids last for on hard mode?").getInt();
        } catch(Exception e) {
        } finally {
